...
/*T?o quan h? SANPHAM1 ch?a toàn b? d? li?u c?a quan h? SANPHAM. T?o quan h? 
KHACHHANG1 ch?a toàn b? d? li?u c?a quan h? KHACHHANG.*/
	SELECT * INTO SANPHAM1 FROM SANPHAM
	SELECT * INTO KHACHHANG1 FROM KHACHHANG

/*C?p nh?t giá t?ng 5% ??i v?i nh?ng s?n ph?m do “Thai Lan” s?n xu?t (cho quan h? SANPHAM1) */
	UPDATE SANPHAM1
	SET GIA = GIA * 105/100
	WHERE NUOCSX = 'Thai Lan';

/*C?p nh?t giá gi?m 5% ??i v?i nh?ng s?n ph?m do “Trung Quoc” s?n xu?t có giá t? 10.000 tr? xu?ng 
(cho quan h? SANPHAM1)*/
	UPDATE SANPHAM1
	SET GIA = GIA * 95/100
	WHERE NUOCSX = 'Trung Quoc' AND GIA <= 10000;

/*C?p nh?t giá tr? LOAIKH là “Vip” ??i v?i nh?ng khách hàng ??ng ký thành viên tr??c ngày 
1/1/2007 có doanh s? t? 10.000.000 tr? lên ho?c khách hàng ??ng ký thành viên t? 1/1/2007 tr? v? 
sau có doanh s? t? 2.000.000 tr? lên (cho quan h? KHACHHANG1)*/
	UPDATE KHACHHANG1
	SET LOAIKH = 'Vip'
